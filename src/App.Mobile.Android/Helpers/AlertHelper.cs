...
namespace App.Mobile.Android.Helpers
{
    public class AlertHelper : IAlertHelper
    {
        ...
        public Task<MessageResult> ShowDialog(string title, string message, bool cancelable = false, MessageResult positiveButton = MessageResult.Ok, MessageResult negativeButton = MessageResult.None, MessageResult neutralButton = MessageResult.None, int iconAttribute = Resource.Drawable.Icon)
        {
